...
public class T07ServletContextTest extends HttpServlet {
	...
	/*
	 * 서블릿 컨텍스트 객체 1.서블릿 프로그램이 컨테이너와 정보를 주고 받기 위한 메서드를 제공한다. ex) 파일의 minetype 정보
	 * 가져오기 ,요청정보 보내기 , 로깅 등.
	 * 
	 * 2.웹 애플리케이션 당 1개씩 생성한다. //세션은 사용자 당 1개씩
	 * 
...
//
//		System.out.println("서블릿컨텍스트의 기본경로:" + ctx.getContextPath());
//		System.out.println("서버 정보: " + ctx.getServerInfo());
//		System.out.println("서블릿api의 메이저 버전정보" + ctx.getMajorVersion());
//		System.out.println("서블릿api의 마이너 버전 정보: " + ctx.getMinorVersion());
//		System.out.println("배포기술자에 기술된 컨텍스트명: " + ctx.getServletContextName());
//		System.out.println("리소스 경로 목록: " + ctx.getResource("/"));
//		System.out.println("파일에 대한 mine타입 정보" + ctx.getMimeType("a.mp3"));
//		System.out.println("파일시스템상의 실제 경로: " + ctx.getRealPath("/"));
//
////		속성값 설정
//		ctx.setAttribute("attr", "속성1");
//		// 속성값 변경
