package HighJava.src.Thread;
        ...
        여러스레드를 분할하여 작업을 하였을 때 시간을 확인해보자
         */

public class T04TreadTest {
    public static void main(String[] args) {
        SumThread sumThread = new SumThread(1L, 2000000000L);
        ...
        System.out.println("스레드1개로 처리할 때의 처리시간(ms): " + (endTime - startTime));
        System.out.println("\n\n");
        //↑는 단일 스레드
        //↓ 멀티 스레드
        ...
        System.out.println("협력 처리했을 때의 처리시간(ms): " + (endTime - startTime));
    }
}
