...
/*
문제) 학번(int), 이름(String), 국어점수, 영어점수, 수학점수
      총점, 등수를 멤버로 갖는 Student클래스를 만든다.
      ...
      List에 저장된 데이터(Student)는 학번의 오름차순으로 정렬할 수 있는 
      내부 정렬 기준을 구현한다.
      그리고, 총점의 역순으로 정렬하는데 총점이 같으면 이름의 오름차순으로
...
public class StudentTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("총점의 내림차순으로 정렬후...");
		for(Student std : stdList){
			System.out.println(std);
		}
		System.out.println();
