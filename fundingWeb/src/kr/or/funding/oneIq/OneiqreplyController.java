...
@WebServlet(value= "/oneiq/oneiqreplay.do")
public class OneiqreplyController extends HttpServlet{

	public OneiqreplyController() {
		super();
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int cnt = oneiqService.replayModifyOneiq(mv);
