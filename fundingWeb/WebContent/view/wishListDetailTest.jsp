...
<body>
   ...
   <form id="" action="/Funding/wishlist/wishlistinsert.do" method="post">
            ...
            <table id="notice_style">
                <thead id="table_thd">
                    <tr>
                        <th>회원번호</th>
                        <td>
                            <input type="text" id="mbsNum" name="mbsNum" autofocus required>
                        </td>
                    </tr>
                </thead>
                <tr>       	              
                <tr id="table_middle">
                    <td>상품번호</td>
                    <td>
                        <input type="text" id="ptNum" name="ptNum" autofocus required><br>
