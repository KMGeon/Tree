            ...
            <div id="content">
                <div class="page_aticle aticle_type2" style="boarder: 1px solid black">
                    <div id="snb" class="snb_my">
                        <h2 class="tit_snb">판매자 Mypage</h2>
                        <div class="inner_snb">
                            <ul class="list_menu">
                                <li>
                                    <a href="#">공지사항</a>
        ...
        <div id="mem_location"
            ...
            <div id="member_menu">
                ...
                <div id="memMenufoot">
                    <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   판매자&nbsp;</strong>
                    <br><br>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=memVo.getMbsNm() %></p><br> 
                </div>
                    <input id="memberlogout2" type="button" value="개인정보수정" onclick="location.href = './판매자개인정보수정.html'">
            ...
            <div id="member_page">
                ...
                <ul>
                    <li class="page_li">
                        <a href="/Funding/view/CusUpdateInfo.jsp" >정보수정</a>
                    </li>
                    <li class="page_li">
                        <a href="/Funding/view/register_funding.jsp" >상품 등록</a>
                    </li>
                    <li class="page_li">
                        등록된 펀딩
                    </li>
                ...
                <ul id="num2">
                    <li class="page_li">
                       <a href="/Funding/view/DeleteMember.jsp">회원탈퇴</a>
                    </li>
                    <li class="page_li">
                        리뷰관리
                    </li>
            ...
            <div id="middle">
                <a id="middle_mem" href="../main/main.html"><strong> 신규 구매 / 리뷰를 통하여 배송비 3000원 마일리지 쿠폰을 알아보세요</strong></a>
            </div>
            <div id="foot">
