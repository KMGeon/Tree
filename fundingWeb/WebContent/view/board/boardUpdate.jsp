...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
	<%
		Notice2VO mv = (Notice2VO) request.getAttribute("mv");
	%>
...
<body>
        ...
        <div id="header">
            ...
            <div class="gnb">
                ...
                <ul class="gnb_menu">
                    ...
                    <li class="list">
                        <a href="/Funding/notice2/notice2List.do" class="link">
    ...
    <form id="" action="/Funding/notice2/notice2Update.do" method="post" enctype="multipart/form-data">
        <div style="position: absolute; height:70%; width:750px; top:200px; left:35%">
            <h1>공지사항 수정페이지</h1>
            ...
            <table id="notice_style">
                <thead id="table_thd">
                    <tr>
                        <th>공지제목</th>
                        <td>
                            <input type="text" name="ntTit"  autofocus required value="<%=mv.getNtTit()%>">
                        </td>
                    </tr>
                </thead>
                <tr>
                ...
                <td>
                        <input type="hidden" name= "ntNum" value="<%=mv.getNtNum() %>">
                        <input type="hidden" name="ntClf" value="<%=mv.getNtClf() %>">
				</td>
                ...
                <tr id="table_middle">
                    <td>내용</td>
                    <td>
                        <textarea name="ntCnt" rows="30" cols="100" required><%=mv.getNtCnt() %></textarea>
              		   첨부파일명 : <input type="file" name="myfile">
                    </td>
                </tr>
                <tr>
                    <td colspan="1">
