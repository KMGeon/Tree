...
<body>
	...
	<div class="container">
		<div class="text-right">
			<a href="?productId=${data.productId}&language=ko">Korea</a> | <a
				href="?productId=${data.productId}&language=en">English</a>
		</div>
		<form name="newProduct" action="/update" class="form-horizontal"
			method="post">
			<div class="form-group row">
				<label class="col-sm-2"><spring:message code="productId" /></label>
				<div class="col-sm-3">
					<input type="text" id="productId" name="productId"
						class="form-control" value="${data.productId}" readonly="readonly">
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" id="unitPrice" name="unitPrice"
						class="form-control" value="${data.unitPrice}">
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" id="manufacturer" name="manufacturer"
						class="form-control" value="${data.manufacturer}">
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" id="category" name="category"
						class="form-control" value="${data.category}">
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" id="unitInStock" name="unitInStock"
						class="form-control" value="${data.unitInStock}">
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				<div class="col-sm-offset-2 col-sm-10">
					<input type="button" class="btn btn-primary"
						...
						onclick="checkAddProduct()" /> <a href="products"
						class="btn btn-warn"><spring:message code="productList" /></a>
				</div>
			</div>
		</form>
	</div>
