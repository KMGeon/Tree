         ...
         <div class="card card-primary">
            ...
            <div class="card-body">
               <div class="form-group">
                  ...
                  <!-- 
                     1) button
                        data-toggle="modal" data-target="샾 modal-lg"
                     2) a
                        data-toggle="modal" href="샾modal-lg"
                     3) 기타
                        data-toggle="modal" data-target="샾modal-lg
                   -->                  
                  <div style="width:30%;float:right; class="data-toggle="modal" href="#modal-lg">
               ...
               <div class="form-group">
                  <label for="insertDate">입력 일자</label> 
   ...
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <div class="modal-header">
            <h4 id="head-title" class="modal-title">책 검색</h4>
         ...
         <div class="modal-body">
            ...
            <div class="row">
                   <div class="col-md-8 offset-md-2">
                       <div class="input-group">
                         <input type="search" id="inpSearch" class="form-control form-control-lg" placeholder="Type your keywords here">
                         <div class="input-group-append">
               ...
               <div class="col-md-10 offset-md-1">
                  <div class="list-group">
                     <div class="list-group-item">
                        <div class="row">                                                             
                           <div class="col-auto">                                                    
                              <img class="img-fluid" src="/resources/upload/noimage.jpg"               
                                 alt="Photo" style="max-height: 160px;">                           
                           </div>                                                                    
                           <div class="col px-4">                                                    
                              <div>                                                     
                                 <div class="float-right">2021-04-20 10:14pm</div>
                                 <h3 id="modalTitle">Lorem ipsum dolor sit amet</h3>                               
      ...
      $.ajax({
         ...
         success: function(result) {
            ...
            $.each(result, function(index, item) {
               ...
               content += "<img class='img-fluid' src='/resources/upload" + filename + "'alt='Photo' style='max-height: 160px;'>";
               content += "</div>";
               ...
               content += "<p class='mb-0'>" + cont.substring(0, 200) + "</p>";
               content += "</div>";
               content += "</div>";
               content += "</div>";
               content += "</div>";
...
function fn_go(geta) {
   ...
   $.each(bookVOList, function(index, item) {
      ...
      if(str == bookId) {
         ...
         // $("#category option:selectd").css("selected", "selected");
         // 가격(price)
