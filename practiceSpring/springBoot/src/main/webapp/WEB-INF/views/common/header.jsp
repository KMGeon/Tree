        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            ...
            <c:if test="${empty mvo}">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="${contextPath}/memLoginForm"><span class="glyphicon glyphicon-log-in"></span> 로그인</a></li>
                    <li><a href="${contextPath}/memJoin"><span class="glyphicon glyphicon-user"></span> 회원가입</a></li>
                </ul>
            </c:if>
            <!-- -세션이 있으면->
            <c:if test="${!empty mvo}">
