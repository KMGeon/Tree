...
<body>
    ...
    <form id="" action="/Funding/oneiq/oneiqupdate.do" method="post">
            ...
            <table id="notice_style">
                <thead id="table_thd">
                    <tr>
                        <th>문의제목</th>
                        <td>
                            <input type="text" name="iqTit"  autofocus required value="<%=mv.getIqTit()%>">
                        </td>
                    </tr>
                </thead>
                <tr>
				...
				<script>
				$("#cgy").val("<%=mv.getIqCgy()%>").attr("selected", "selected");
                ...
                <tr id="table_middle">
                    <td>내용</td>
                    <td>
                        <textarea name="iqCnt" rows="30" cols="100" required><%=mv.getIqCnt() %></textarea>
                    </td>
                </tr>
                <tr>
                    <td colspan="1">
