    ...
    <div id="wrap">
        ...
        <div style="position: absolute; height:70%; width:750px; top:200px; left:35%">
            ...
            <table id="notice_style">
                ...
                <tr>
                    <td>내용</td>
                    <td style="font-size: 19px"><%=mv.getNtCnt()%></td>
               </tr>
               
                
                <tr id="colspan1">
                    <td colspan="3">
                    	<a href="notice2List.do">[목록 돌아가기]</a> 
                    	<%if(memVo.getMbsAhy() == 0){ %>
                        <a href="notice2Update.do?NtNum=<%=mv.getNtNum() %>">[수정하기]</a>
	      				<a href="notice2Delete.do?NtNum=<%=mv.getNtNum() %>">[글 삭제]</a>
	      				<%}else{ %>
	      				<%} %>
                    </td>
                </tr>
