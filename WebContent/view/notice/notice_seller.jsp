...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
 	List<Notice2VO> noticeList = (List<Notice2VO>) request.getAttribute("boardList");
		...
		<div id="header">
			<div class="user_menu">
				...
				<ul class="sign_menu">
					...
					<% if(memVo == null){ %>
					<li class="link"><a href="/Funding/view/joinselect.html"
		...
		<table class="notice_style" style="width: 100%; height: 600px">
			...
			<tbody>
				...
				<tr>
					...
					<td style="width: 60%"><a href="javascript:detailNotice()"><%=noticeList.get(i).getNtTit()%></a></td>
					<td style="font-size: 12px"><%=simpleDateFormat.format(noticeList.get(i).getNtWriteDt())%></td>
				</tr>
