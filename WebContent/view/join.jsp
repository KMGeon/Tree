            ...
            <div id="content">
                <div class="page_aticle">
                    <div class="type_form member_join">
                        <form id="form" action="/Funding/member/insertCus.do" method="POST" onsubmit="return on_submit_check();">
                            ...
                            <table class="tbl_comm">
                                <tbody>
                                    <tr class="fst field_id">
                                        ...
                                        <td>
                                            <input type="text" name="mbsId" id="id" maxlength="16" required="" option="regId"
                                                onclick="id_check1()" placeholder="6자 이상의 영문 혹은 영문과 숫자를 조합">
                                    ...
                                    <tr class="field_code">
                                        ...
                                        <td>
                                            <input type="hidden" name="rfCd" required="" label="이름"
                                                placeholder="추천인 코드를 입력해주세요" value="-1">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
