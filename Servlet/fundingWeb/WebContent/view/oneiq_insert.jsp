...
<body>
    ...
    <form id="" action="/Funding/oneiq/oneiqinsert.do" method="post">
            ...
            <table id="notice_style">
                <thead id="table_thd">
                    <tr>
                        <th>문의제목</th>
                        <td>
                            <input type="text" id="iqTit" name="iqTit" autofocus required>
                        </td>
                    </tr>
                </thead>
                <tr>
                    <tbody id="table_tb">
                        <td>회원 번호</td>
                        <td><input type="text" name="mbsNum" value="<%=memVo.getMbsNum() %>" readonly></td>
                </tr>
		                <tr>
		                    <td>문의 유형</td>
		                    <td>
		                        <select name="iqCgy">
		                            <option value="신고하가">신고하기</option>
                ...
                <tr id="table_middle">
                    <td>내용</td>
                    <td>
                        <textarea name="iqCnt" rows="30" cols="100" required></textarea><br>
