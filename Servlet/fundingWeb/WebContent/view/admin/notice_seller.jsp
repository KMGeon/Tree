...
<body>
    <div id="wrap">
            ...
            <div id="content">
                <div class="page_aticle aticle_type2" style="boarder: 1px solid black">
                    <div id="snb" class="snb_my">
                        <h2 class="tit_snb">관리자 Mypage</h2>
                        <div class="inner_snb">
                            <ul class="list_menu">
                                <li>
                                    <a href="#">공지사항</a>
        ...
        <div id="mem_location"
            ...
            <div id="member_menu">
                <img id="memberlogo" src="./img/KakaoTalk_20220914_173115155.png" alt="회원들 이미지 로고">
                <div id="memMenufoot">
                    <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   관리자&nbsp;</strong>
                    <br><br>
                    <p>&nbsp;&nbsp;누구누구님</p><br> 
            ...
            <div id="member_page">
                ...
                <ul>
                    <li class="page_li">
                        <a href="./register_funding.html" >회원관리</a>
                    </li>
                    <li class="page_li">
                        <a href="/Funding/view/admin/approve.jsp" >판매자 승인</a>
                    </li>
                    <li class="page_li">
                        등록된 펀딩
                    </li>
