...
<%@page import="kr.or.funding.comm.vo.AtchFileVO"%>
<%@page import="java.util.List"%>
...
<body>
	<div id="wrap">
			...
			<div class="user_menu">
				...
				<ul class="sign_menu">
					...
					<li class="link"><a href="#" class="item after join"><%=memVo.getMbsNm()%>님
							어서오세요</a></li>
					<%
					if (memVo.getMbsAhy() == 2 && memVo.getUseAt().equals('Y')) {
					%>
					...
					%>
					<%
					if (memVo.getMbsAhy() == 2 && memVo.getUseAt().equals('N')) {
					%>
					<li class="link"><a href="/Funding/view/main.jsp"
						class="item after login_none">판매자페이지</a></li>
					<%
					}
					%>
		...
		<div id="mem_location"
			...
			<div id="member_menu">
				<img id="memberlogo" src="/Funding/view/prof.png" alt="회원들 이미지 로고">
				<div id="memMenufoot">
					<strong style="float: center">관리자</strong> <br> <br>
				</div>
			...
			<div id="member_page">
				<div id="sellerList">판매자 회원가입 목록</div>
				<hr>
				<table id="containerA">
					<tr>
						<th>아이디</th>
					...
					<tr>
						...
						<td><a
							href="<%=request.getContextPath()%>/filedown.do?fileId=<%=memList.get(i).getAtchFileId()%>&fileSn=1">다운로드</a>
						</td>

						<td><input type="button" id="approveBtn" value="등록"
							onclick="location.href='/Funding/member/approveUdate.do?mbsId=<%=memList.get(i).getMbsId()%>';"></td>
