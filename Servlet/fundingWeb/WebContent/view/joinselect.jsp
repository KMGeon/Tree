...
<head>
    ...
    <link rel="stylesheet" href="/Funding/view/css/joinselect.css">
    <script src="/Funding/js/common.js"></script>
</head>
        ...
        <div id="header">
            <div class="user_menu">
                  ...
                  <ul class="sign_menu">
                    ...
                    <% if(memVo == null){ %>
                    <li class="link">
                        <a href="./joinselect.html" class="item after join">회원가입</a>
                    </li>
                    <li class="link">
            ...
            <div id="content" >
                <div class="section_login" >
                    <h3 class="tit_login">회원가입 선택</h3>

                    <a href="/Funding/view/join.jsp" class="btn_type2 btn_member">
                        <span class="txt_type">일반회원</span>
                    </a>
                    <a href="/Funding/view/seller_join.jsp" class="btn_type2 btn_member">
                        <span class="txt_type">판매자</span>
                    </a>    
                </div>
            </div>
