...
<body>
    ...
    <form id="" action="/Funding/notice2/notice2Insert.do" method="post" enctype="multipart/form-data">
            ...
            <table id="notice_style">
                <thead id="table_thd">
                    <tr>
                        <th>공지사항 제목</th>
                        <td>
                            <input type="text" id="ntTit" name="ntTit" autofocus required>
                        </td>
                    </tr>
                </thead>
                <tr>
                ...
                <tr id="table_middle">
                    <td>내용</td>
                    <td>
                        <textarea name="ntCnt" rows="30" cols="100" required></textarea><br>
                  		   
                		<input type="submit" class="custom-btn btn-1" value="등록하기">                      
                    </td>
                </tr>          
           </table>
        </div>
