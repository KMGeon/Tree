 ...
 <% MemberVO memVo = (MemberVO) session.getAttribute("memList");%>
	<div id="wrap">
		...
		<div id="mem_location"
			...
			<div id="member_menu">
				<img id="memberlogo" src="./img/KakaoTalk_20220914_173115155.png"
					alt="회원들 이미지 로고">
				<div id="memMenufoot">
			...
			<form id="form" action="/Funding/member/update.do" method="POST"
				onsubmit="return on_submit_check();">
				<div id="member_page">
					<div id="sellerList">일반회원 정보수정</div>
					<hr>
					<table border="1px solid black">
						<tr>
							<td>I D:</td>
							<td><%=memVo.getMbsId()%></td>
						</tr>
						<tr>
							<td>이름:</td>
