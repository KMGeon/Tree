...
<body>
	...
	<div id="wrap">
		...
		<div id="mem_location"
			style="border: 1px solid ; position: absolute; height: 78%; width: 681px; top: 200px; left: 35%">
			<div id="member_menu">
				<img id="memberlogo" src="/Funding/view/prof.png"
					alt="회원들 이미지 로고">
				<div id="memMenufoot">
				
					<strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=memVo.getMbsNm() %></strong> <br>
					<br>
					<p>&nbsp;&nbsp;&nbsp;&nbsp;<%=memVo.getMbsNm() %></p>
					<br>
				</div>
				...
				<div id="member_page">
					...
					<tr>
							...
							<td><input type="text" name="mbsId"
								value="<%=memVo.getMbsId()%>" readonly /></td>
					...
					<hr>
					<input type="submit" value="회원정보수정" id="resumeBtn" style="float: left;"/>
