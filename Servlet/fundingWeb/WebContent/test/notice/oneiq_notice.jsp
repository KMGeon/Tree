...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
 	List<OneiqVO> oneiqList = (List<OneiqVO>) request.getAttribute("boardList");
...
<body>
	...
	<div
		...
		<table class="notice_style" style="width: 100%; height: 600px">
			...
			<tbody>
				...
				<tr>
					...
					<td style="width: 60%"><a href="javascript:detailoneiq()"><%=oneiqList.get(i).getIqTit()%></a></td>
		...
		<a id="pagenum" href="oneiq_list.do?pageNum=<%=startPage-pageBlock%>">&nbsp;Prev</a>
		<%} %>

		<% for(int i=startPage;i<=endPage;i++){ %>
		<a id="pagenum" href="oneiq_list.do?pageNum=<%=i%>"><%=i %>&nbsp;</a>
		<%} %>

		<% if(endPage<pageCount){ %>
		<a id="pagenum" href="oneiq_list.do?pageNum=<%=startPage+pageBlock%>">&nbsp;Next</a>
		<%} %>
		<%} %>
	</div>
