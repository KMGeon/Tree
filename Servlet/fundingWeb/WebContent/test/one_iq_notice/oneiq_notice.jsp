		...
		<table class="notice_style" style="width: 100%; height: 600px">
			...
			<tbody>
				...
				<tr>
					...
					<td style="width: 60%">
					<a href="oneiqDetail.do?iqNm=<%=oneiqList.get(i).getMbsNum()%>"><%=oneiqList.get(i).getIqTit()%></a></td>			
				...
				<td colspan="1">
				<input type="button" value="등록하기" onclick ="self.location='/Funding/oneiq/oneiqinsert.do'">			
				</td><br>
		<br>
