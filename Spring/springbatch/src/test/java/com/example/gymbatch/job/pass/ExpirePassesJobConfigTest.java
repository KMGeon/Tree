package com.example.gymbatch.job.pass;

import com.example.gymbatch.config.TestBatchConfig;
import com.example.gymbatch.repository.pass.PassEntity;
import com.example.gymbatch.repository.pass.PassRepository;
import com.example.gymbatch.repository.pass.PassStatus;
...
@SpringBatchTest
@SpringBootTest(classes = {ExpirePassesJobConfig.class, TestBatchConfig.class})
