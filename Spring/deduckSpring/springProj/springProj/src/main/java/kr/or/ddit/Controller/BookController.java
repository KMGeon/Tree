...
public class BookController {
	...
	public ModelAndView create() {
		/*
		 * ModelAndView 1) Model : return할 데이터(String, int, List, Map, VO..)를 담당 2) View
		 * : 화면을 담당(뷰(view : JSP)의 경로) ViewResolver => prefix + jsp파일명 + suffix
		 */
	...
	// BookVO :
	// {"bookId":0,"title":"개똥이월드","category":"소설","price":"10000","insertDate",""}
