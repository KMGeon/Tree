...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<a href="index3.html" class="brand-link"> <img
		...
		style="opacity: .8"> <span class="brand-text font-weight-light">개똥이페이</span>
	</a>
			...
			<ul class="nav nav-pills nav-sidebar flex-column"
               ...
               with font-awesome or any other icon font library -->
				...
				<li class="nav-item"><a href="#" class="nav-link"> <i
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="/book/list" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
								<p>도서목록</p>
						</a></li>
						<li class="nav-item"><a href="/book/insert" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
								<p>도서등록</p>
						</a></li>
					</ul></li>
				...
				<li class="nav-item"><a href="#" class="nav-link"> <i
						...
						<p>
							이미지갤러리 <i class="right fas fa-angle-left"></i>
						</p>
				</a>
					<ul class="nav nav-treeview">
